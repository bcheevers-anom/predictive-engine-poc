...
REFRESH_BEFORE_EXPIRY_SECONDS = 10 * 60  # refresh 10 minutes before expiry (sessions are 1hr)
...
def main():
    ...
    print(f"  Refreshes 10 minutes before expiry (sessions are 1hr, so ~every 50min)")
